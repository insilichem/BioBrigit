"""
Simple script for executing BioBrigit over all files in a directory.
...
def parse_cli() -> dict:
    ...
    p.add_argument("target_dir", type=str,
    ...
    p.add_argument("--outputdir", type=str, default=None,
...
def welcome() -> None:
    ...
    """
    message = "Using BioBrigit over all files in a directory by Raúl Fernández-Díaz"
    print("-" * (len(message) + 4))
    print("| " + message + " |")
    print("-" * (len(message) + 4))
    print()
